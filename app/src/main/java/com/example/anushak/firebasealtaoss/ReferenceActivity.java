...
public class ReferenceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            text.setText("HR Dashboard - Interview Dashboard - Reference candidates List");
        }
        else if(UserType.equals("admin"))
        {
            text.setText("Admin Dashboard - Interview Dashboard - Reference candidates List");
        }
        ...
        dashboard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ReferenceActivity.this,AdminDashboard.class);
        ...
        list.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ReferenceActivity.this,InterviewDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        dashboard1.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ReferenceActivity.this,HrDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        Query query=mDatabase.orderByChild("status").equalTo("Reference");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(ReferenceActivity.this, ListViewClickData.getFull_name(), Toast.LENGTH_SHORT).show();
                Intent intent=new Intent(ReferenceActivity.this,Show_Reference_List.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            Intent intent = new Intent(ReferenceActivity.this, AddReferenceActivity.class);
            intent.putExtra("userId",UserId);
            intent.putExtra("usertype",UserType);
            startActivity(intent);
        }
        if(id == R.id.query)
        {
            ...
            Intent i = new Intent(ReferenceActivity.this, QueryForm.class);
