...
public class addschedule_Activity extends AppCompatActivity {
    ...
    EditText fullname , qualifi, freshers, email, mobileno,desgination, project;
    Button register;
    TextView selected,schedulestatus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addschedule_);

        databaseReference = FirebaseDatabase.getInstance().getReference("Interviews");
        selected = (TextView) findViewById(R.id.selected);
        schedulestatus = (TextView) findViewById(R.id.schedule);
        ...
        {
            text.setText("HR Dashboard - Interview Dashboard - Scheduled Candidates List - New Candidate Form");
        }
        else if(UserType.equals("admin"))
        {
            text.setText("Admin Dashboard - Interview Dashboard - Scheduled Candidates List - New Candidate Form");
        }
        ...
        dashboard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(addschedule_Activity.this,AdminDashboard.class);
        ...
        list.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(addschedule_Activity.this,InterviewDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        history.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(addschedule_Activity.this,scheduleActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        dashboard1.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(addschedule_Activity.this,HrDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
    ...
    private void schedule(){
        ...
        String Walk = schedulestatus.getText().toString().trim();

        if(!TextUtils.isEmpty(FullName)){
            String id = databaseReference.push().getKey();

            Intervi intervi = new Intervi(id, FullName,Qualifications, Fresher, Email,Mobile ,Designation ,Project,Sel,Walk);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.query)
        {
            ...
            Intent i=new Intent(addschedule_Activity.this,QueryForm.class);
