...
import com.example.anushak.firebasealtaoss.model.Configuration;
...
public class UserProfileFragment extends Fragment {
    ...
    public void setupArrayListInfo(User myAccount){
        listConfig.clear();
       /* Configuration userNameConfig = new Configuration(USERNAME_LABEL, myAccount.Empid, R.drawable.ic_account_circle_black_24dp);
        listConfig.add(userNameConfig);*/

        Configuration emailConfig = new Configuration(EMAIL_LABEL, myAccount.email, R.drawable.ic_email_black);
