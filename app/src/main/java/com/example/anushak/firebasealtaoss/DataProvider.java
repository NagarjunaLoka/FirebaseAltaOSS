...
public class DataProvider {
    ...
    public static HashMap<String, List<String>> getInfo()
    {
        ...
        Ques1.add("AltaChat is a messaging app with a focus on speed and security, it’s super-fast, simple and free. You can use Telegram on all your devices at the same time — your messages sync seamlessly across any number of your phones, tablets or computers.\n" +
                "\n" +
                "With AltaChat, you can send messages, photos, videos and files of any type (doc, zip, mp3, etc), as well as create groups for up to 200,000 people or channels for broadcasting to unlimited audiences. AltaChat is like email combined — and can take care of all your personal needs.");
        ...
        Ques3.add("You can use AltaChat on smartphones, tablets which are having Android (4.1 and up). You can also use AltaChat's web version for Windows(which we are going to launch soon).\n" +
                "\n" +
                "You can log in to AltaChat from as many of your devices as you like — all at the same time. Just use your email to log in everywhere.");
        ...
        Ques8.add("In the unfortunate case that your phone becomes lost or stolen, we can help make sure that no one can use your AltaChat account.\n" +
                "\n" +
                "What to do\n" +
                "Change Your Password\n" +
                "\n" +
                "How to do\n" +
                "Open AltaChat in another mobile. Tap Forgot Password after entering your email-id, then it will send a mail to your email-id to reset your password");
        ...
        Ques9.add("AltaChat uses your phone's Internet connection (4G/3G/2G/EDGE or Wi-Fi, as available) to send and receive messages to your friends and family. You don't have to pay for every message. As long as you haven't exceeded your data limit or you're connected to a free Wi-Fi network, your carrier shouldn't charge you extra for messaging over AltaChat\n"+
                ...
                "Please be aware that:\n" +
                        "\n" +
                        "If your phone is roaming, additional mobile data charges may apply. Learn how to configure roaming settings for AltaChat on: Android | iPhone | Windows Phone\n" +
        ...
        Ques13.add("To add a new Firend:\n" +
                "\n" +
                "Click on the ADD(+) button in friends list page. It will ask you to enter friend email whom you are going to add and press ok.\n"+
                "It will add your friend in your friends list.");

        List<String> Ques14= new ArrayList<String>();
        Ques14.add("To add a new Group:\n" +
                "\n" +
                "Click on the AddGroup button which is at the right bottom of the groups page.It will ask to enter Group name and the friends whom you wish to add in that group(By checking on the friend name you can add him/her to the group)\n"+
        ...
        MoviesDetails.put("What If we Lost and stolen phones? Or we lost Password?", Ques8);
