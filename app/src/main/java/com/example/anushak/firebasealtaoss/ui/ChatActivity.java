...
import com.example.anushak.firebasealtaoss.Wallpapers;
...
import com.example.anushak.firebasealtaoss.emoji.Emojicon;
import com.example.anushak.firebasealtaoss.emoji.EmojiconGridView;
import com.example.anushak.firebasealtaoss.emoji.EmojiconsPopup;
import com.example.anushak.firebasealtaoss.model.Consersation;
import com.example.anushak.firebasealtaoss.model.Message;
import com.example.anushak.firebasealtaoss.service.ServiceUtils;
import com.example.anushak.firebasealtaoss.util.ImageUtils;
import com.example.anushak.firebasealtaoss.view.FullScreenImageActivity;
import com.example.anushak.firebasealtaoss.view.VideoPlayerActivity;
...
public class ChatActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView empty,nameFriendText;
    ProgressBar progressBar;

    String nameFriend,profileFriend;

    private CircleImageView chat_avatar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileFriend=intentData.getStringExtra(StaticConfig.INTENT_KEY_CHAT_AVATA);
        ...
        if (idFriend != null && nameFriend != null) {
         //  getSupportActionBar().setTitle(nameFriend);
            ...
            try {
                ...
                Bitmap src;
                if (profileFriend.equals("default")) {
                    src = BitmapFactory.decodeResource(res, R.drawable.ic_person_black_24dp);
                } else {
                    byte[] decodedString = Base64.decode(profileFriend, Base64.DEFAULT);
