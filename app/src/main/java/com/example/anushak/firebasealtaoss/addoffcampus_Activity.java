...
public class addoffcampus_Activity extends AppCompatActivity {

    EditText fullname , qualifi, freshers, email, mobileno,desgination, project,rename,reid;
    Button register;
    TextView selected,offcstatus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addoffcampus_);
        databaseReference = FirebaseDatabase.getInstance().getReference("Interviews");
        selected = (TextView) findViewById(R.id.selected);
        offcstatus = (TextView) findViewById(R.id.offstatus);
        ...
        {
            text.setText("HR Dashboard - Interview Dashboard - Off-Campus Candidates List - New Candidate Form");
        }
        else if(UserType.equals("admin"))
        {
            text.setText("Admin Dashboard - Interview Dashboard -  Off-Campus Candidates List - New Candidate Form");
        }
        ...
        dashboard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(addoffcampus_Activity.this,AdminDashboard.class);
        ...
        list.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(addoffcampus_Activity.this,InterviewDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        history.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(addoffcampus_Activity.this,offcampus_activity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        dashboard1.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(addoffcampus_Activity.this,HrDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                offcampus();
                /*Intent intent = new Intent(addoffcampus_Activity.this,offcampus_activity.class);
                intent.putExtra("select",selected.getText().toString());
                startActivity(intent);*/
            }
        });
    }

    private void offcampus(){
        ...
        String Ref = offcstatus.getText().toString().trim();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.query)
        {
            ...
            Intent i=new Intent(addoffcampus_Activity.this,QueryForm.class);
