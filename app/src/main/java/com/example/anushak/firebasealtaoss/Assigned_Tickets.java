...
public class Assigned_Tickets extends AppCompatActivity {

    private RecyclerView recyclerView;
    private Assigned_task_Adapter adapter;
    ...
    public static final String Name1 = "person_name1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assigned__tickets);
        ...
        adapter = new Assigned_task_Adapter(this, artistList);
        ...
        dashboard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Assigned_Tickets.this,EmployeeDashboard.class);
        ...
        list.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Assigned_Tickets.this,Ticketing_Dashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        dashboard1.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Assigned_Tickets.this,HrDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        dashboard2.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Assigned_Tickets.this,AdminDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        {
            text.setText("Employee Dashboard - Ticketing Dashboard - Assigned Tickets");
        }
        else
        if(UserType.equals("hr"))
        {
            text.setText("HR Dashboard - Ticketing Dashboard - Assigned Tickets");
        }
        else if(UserType.equals("admin"))
        {
            text.setText("Admin Dashboard - Ticketing Dashboard - Assigned Tickets");
        }
        ...
        //////Shared Preferences
                ...
                String n = usertype.getText().toString();
                 String n1 = userid.getText().toString();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.query) {
            ...
            Intent i = new Intent(Assigned_Tickets.this, QueryForm.class);
