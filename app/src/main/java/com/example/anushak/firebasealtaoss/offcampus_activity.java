...
public class offcampus_activity extends AppCompatActivity {

    ImageView addrefer;
    ListView listView;
    private DatabaseReference mDatabase;
    private RefandoffcampusAdapter mList;
    String update;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_offcampus_activity);
        addrefer=(ImageView)findViewById(R.id.image);
        update=getIntent().getStringExtra("select");
        ...
        {
            text.setText("HR Dashboard - Interview Dashboard - Off Campus candidates List");
        }
        else if(UserType.equals("admin"))
        {
            text.setText("Admin Dashboard - Interview Dashboard - Off Campus candidates List");
        }
        ...
        dashboard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(offcampus_activity.this,AdminDashboard.class);
        ...
        list.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(offcampus_activity.this,InterviewDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        dashboard1.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(offcampus_activity.this,HrDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        Query query=mDatabase.orderByChild("status").equalTo("Off-Campus");
        mList = new RefandoffcampusAdapter(query, this, R.layout.listview3);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(offcampus_activity.this, ListViewClickData.getFull_name(), Toast.LENGTH_SHORT).show();
                Intent intent=new Intent(offcampus_activity.this,show_offcampus_list.class);
                ...
                intent.putExtra("referencename",ListViewClickData.getReferename());
                intent.putExtra("referenceid",ListViewClickData.getRefereid());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            Intent intent = new Intent(offcampus_activity.this, addoffcampus_Activity.class);
            intent.putExtra("userId",UserId);
            intent.putExtra("usertype",UserType);
            startActivity(intent);
        }
        if(id == R.id.query)
        {
            ...
            Intent i = new Intent(offcampus_activity.this, QueryForm.class);
