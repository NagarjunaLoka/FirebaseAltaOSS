...
public class Open_Tickets extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Open_Tickets.this,Ticketing_Dashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        {
            text.setText("Employee Dashboard - Ticketing Dashboard - Open Tickets");
        }
        else
        if(UserType.equals("hr"))
        {
            text.setText("HR Dashboard - Ticketing Dashboard - Open Tickets");
        }
        else if(UserType.equals("admin"))
        {
            text.setText("Admin Dashboard - Ticketing Dashboard - Open Tickets");
        }
