...
public class updateschedule_Activity extends AppCompatActivity {

    EditText idinter, name, fresh, mobile, designation;
    String Idinter, Name, Fresh , Mobile ,Designation, Qualify ,Eid,Proj,Stats,Updates;
    Button update;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_updateschedule_);
        ...
        if(UserType.equals("hr")) { text.setText("HR Dashboard - Interview Dashboard - Scheduled Candidates List - Candidate Details - Update"); }
        else if(UserType.equals("admin")) { text.setText("Admin Dashboard - Interview Dashboard - Scheduled Candidates List - Candidate Details - Update"); }
        ...
        dashboard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(updateschedule_Activity.this,AdminDashboard.class);
        ...
        list.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(updateschedule_Activity.this,InterviewDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        history.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(updateschedule_Activity.this,scheduleActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        details.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(updateschedule_Activity.this,show_schedule_list_Activity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        dashboard1.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(updateschedule_Activity.this,HrDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
    ...
    private void inter(){
        ...
        if(!TextUtils.isEmpty(FullName)){
            ...
            Intervi intervi = new Intervi(Idinter, FullName,Qualifications, Fresher, Email,Mobile ,Designation ,Project,Sel,Walk);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.query)
        {
            ...
            Intent i=new Intent(updateschedule_Activity.this,QueryForm.class);
